...
{ 
   ...
   */
   ...
   {  
      double newTotalScore = score + totalScore;
      int newQuizCount = quizCount + 1;
      totalScore = newTotalScore; //this
   ...
   */
   ...
   public static void main(String[] args) {
	Student harvey = new Student("Harvey");
	harvey.addQuiz(10);
	harvey.addQuiz(9);
	System.out.println(harvey.getAverageScore());
